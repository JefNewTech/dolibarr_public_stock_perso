...
/**
 * \file    test/phpunit/PublicStockFunctionalTest.php
 * \ingroup publicstock
...
/**
 * Class PublicStockFunctionalTest
 *
 ...
 *
 * @package Testpublicstock
 */
class PublicStockFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modPublicStock')->click();
		} else {
			// Disable the module
			$this->byHref('modPublicStock')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/publicstock/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('publicstock/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/publicstock/admin/about.php');
		$this->authenticate();
		return $this->assertContains('publicstock/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('publicstockwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modPublicStock_PublicStockTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modPublicStock_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
